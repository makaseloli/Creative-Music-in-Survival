...
public final class CreativeOnlySoundInstance extends SimpleSoundInstance {
    private CreativeOnlySoundInstance(SoundEvent sound) {
        super(sound.getLocation(), SoundSource.MUSIC, 1.0F, 1.0F, SoundInstance.createUnseededRandom(), false, 0, Attenuation.NONE, 0.0, 0.0, 0.0, true);
    }
    ...
    public WeighedSoundEvents resolve(SoundManager soundManager) {
        WeighedSoundEvents event = soundManager.getSoundEvent(this.getLocation());
        if (event == null) {
